...
<ul class="nav nav-pills flex-column gap-1">
    @if($user->role === 'admin')
        ...
        <li class="nav-item"><a class="nav-link {{ \App\Support\MenuHelper::isActive('admin.late-entry-requests.*') }}" href="{{ route('admin.late-entry-requests.index') }}"><i class="bi bi-hourglass-split me-2"></i>Izin Pengisian Susulan</a></li>
    ...
    @elseif($user->role === 'teacher')
        ...
        <li class="nav-item"><a class="nav-link {{ \App\Support\MenuHelper::isActive('teacher.late-entry-requests.*') }}" href="{{ route('teacher.late-entry-requests.index') }}"><i class="bi bi-hourglass-split me-2"></i>Permintaan Izin</a></li>
    @else
